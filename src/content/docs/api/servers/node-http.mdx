---
title: 'Node.js HTTP'
description: 'Mount a contract on the native Node HTTP server with streaming backpressure and native request context.'
---
...
```ts
const publicApi = serverDefinition.implement(
  contract.routes.public,
  publicHandlers
)
...
[client authoring](/docs/api/core/clients) and [client integrations](/docs/api/integrations/query-libraries) for consumer-side composition.
