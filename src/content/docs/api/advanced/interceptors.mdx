...
or a graphical representation of the code above

<SVGInterceptors class="mx-auto mt-4" />

> Keep in mind, the graph above assumes you provided all 3 (`args`, `fn` and `resolver`)  interceptors, but you can provide only the ones you need,
> so obviously the graph would return at the last define part.
