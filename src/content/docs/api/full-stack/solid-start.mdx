...
[contract authoring](/docs/api/core/contracts), then turn it into the server value mounted below:
...
[server authoring](/docs/api/core/servers) for context, middleware, declared errors, and independently deployable
fragments.
