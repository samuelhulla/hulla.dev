---
title: 'React Router'
description: 'Serve a contract through Framework Mode resource routes and consume it from loaders and actions.'
---
...
First define the shared contract from [contract authoring](/docs/api/core/contracts), then create the server value mounted
below:
...
See [server authoring](/docs/api/core/servers) for context, middleware, declared errors, and independently deployable
fragments.
