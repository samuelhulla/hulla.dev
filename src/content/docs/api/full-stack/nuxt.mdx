---
title: 'Nuxt'
description: 'Mount a Nitro route and build a request-aware client for useAsyncData, events, and server handlers.'
---
...
See [contract authoring](/docs/api/core/contracts) and [server authoring](/docs/api/core/servers) for schemas, codecs,
