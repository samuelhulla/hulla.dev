---
title: 'SvelteKit'
description: 'Use catch-all endpoints, enhanced Fetch, or zero-hop remote functions with native RequestEvent context.'
---
...
See [contract authoring](/docs/api/core/contracts) and [server authoring](/docs/api/core/servers) for contracts, context,
