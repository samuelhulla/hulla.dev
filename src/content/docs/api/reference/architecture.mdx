---
title: 'Architecture'
description: 'Trace a contract from declaration through client transport, server execution, and response decoding.'
---
...
Both ordinary schemas run on the server: input to output, never automatically reversed. A codec explicitly adds encode at the sender and decode at the receiver. See [numeric and date round trips](/docs/api/core/value-round-trips).
