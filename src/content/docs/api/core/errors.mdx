---
title: 'Errors'
description: 'Model declared application failures separately from validation, transport, implementation, and runtime failures.'
---
...
type APIErrorIssue = {
  ...
  readonly location?:
    'body' | 'headers' | 'input' | 'output' | 'params' | 'query' | 'response'
}
```
