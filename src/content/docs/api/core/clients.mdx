---
title: 'Typed clients'
description: 'Create a contract-shaped client, choose a transport, narrow declared responses, and add request middleware.'
---
...
For framework-specific client placement, server-only import guards, and native server-function patterns, see [hybrid rendering](/docs/api/full-stack/hybrid-rendering).
...
export async function createUser(
  input: Parameters<typeof client.organizations.createUser>[0]
) {
