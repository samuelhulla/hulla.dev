---
title: 'AWS Lambda'
description: 'Serve a contract through API Gateway HTTP API v2 or a Lambda Function URL.'
---
...
the consumer's own state or query library; see [client authoring](/docs/api/core/clients) and
