---
title: 'Cloudflare'
description: 'Deploy to Module Workers or Pages Functions with native bindings, execution context, and asset fallback.'
---
...
consumer; see [client authoring](/docs/api/core/clients) and [client integrations](/docs/api/integrations/query-libraries).
