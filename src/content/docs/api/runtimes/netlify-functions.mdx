...
description: 'Expose a contract as a Web-native Netlify Function with platform context and deployment configuration.'
---
...
declared response narrows its body and headers. See [client authoring](/docs/api/core/clients) and
[client integrations](/docs/api/integrations/query-libraries).
